    ...
    public class ProductsCPUController : ControllerBase
    {
        ...
        public Response AddProduct(ProductsCPU obj)
        {
            ...
            try
            {
                ...
                string query = "INSERT INTO ProductsCPU (ProductName, Discription, Brand, Discount, Price, Image, BaoHanh, SocKet, SoNhan, SoLuong, KienTruc, TocDo, Cache, ChipDoHoa, TDP, BoNhoHoTro, NgayNhap) " +
                               "VALUES (@ProductName, @Discription, @Brand, @Discount, @Price, @Image, @BaoHanh, @SocKet, @SoNhan, @SoLuong, @KienTruc, @TocDo, @Cache, @ChipDoHoa, @TDP, @BoNhoHoTro, @NgayNhap)";
